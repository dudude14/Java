...
public class Elipse extends Figura
{
    ...
    {
        this (x, y, r1, r2, Color.white,Color.black);
    }
	
    public Elipse (int x, int y, int r1, int r2, Color cor,Color cor1)
    {
        super (cor,cor1);
    ...
    public Elipse (String s)
    {
        ...
        Color cor1 = new Color (Integer.parseInt(quebrador.nextToken()),  // R
        					   Integer.parseInt(quebrador.nextToken()),  // G
                               Integer.parseInt(quebrador.nextToken())); // B

        this.centro = new Ponto (x,y,cor,cor1);
        this.raio1  = r1;
        this.raio2  = r2;
        this.cor    = cor;
    }
    ...
    {
        this.centro = new Ponto (x,y,this.getCor(),this.cor1);
    }
